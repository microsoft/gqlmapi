...
#ifndef PROPVALUEOBJECT_H
#define PROPVALUEOBJECT_H

#include "MAPISchema.h"

namespace graphql::mapi::object {

class [[nodiscard("unnecessary construction")]] PropValue final
...
private:
	...
	explicit PropValue(std::unique_ptr<const Concept> pimpl) noexcept;
...
public:
	template <class T>
	explicit PropValue(std::shared_ptr<T> pimpl) noexcept
