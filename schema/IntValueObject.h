...
class [[nodiscard]] IntValue final
...
private:
	...
	struct [[nodiscard]] Concept
	{
		...
		[[nodiscard]] virtual service::AwaitableScalar<int> getValue(service::FieldParams&& params) const = 0;
	};
		...
		: Concept
	{
		...
		[[nodiscard]] service::AwaitableScalar<int> getValue(service::FieldParams&& params) const final
		{
	...
	IntValue(std::unique_ptr<const Concept>&& pimpl) noexcept;
