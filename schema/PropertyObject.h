...
private:
	...
	struct [[nodiscard]] Concept
	{
		...
		[[nodiscard]] virtual service::AwaitableObject<std::shared_ptr<PropId>> getId(service::FieldParams&& params) const = 0;
		[[nodiscard]] virtual service::AwaitableObject<std::shared_ptr<PropValue>> getValue(service::FieldParams&& params) const = 0;
	};
		...
		: Concept
	{
		...
		[[nodiscard]] service::AwaitableObject<std::shared_ptr<PropId>> getId(service::FieldParams&& params) const final
		{
		...
		[[nodiscard]] service::AwaitableObject<std::shared_ptr<PropValue>> getValue(service::FieldParams&& params) const final
		{
	...
	Property(std::unique_ptr<const Concept>&& pimpl) noexcept;
