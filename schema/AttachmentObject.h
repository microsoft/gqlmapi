...
class [[nodiscard("unnecessary construction")]] Attachment final
...
private:
	...
	explicit Attachment(std::unique_ptr<const Concept> pimpl) noexcept;
...
public:
	template <class T>
	explicit Attachment(std::shared_ptr<T> pimpl) noexcept
