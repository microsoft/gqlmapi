...
class [[nodiscard("unnecessary construction")]] FolderAdded final
...
private:
	...
	struct [[nodiscard("unnecessary construction")]] Concept
	{
		...
		[[nodiscard("unnecessary call")]] virtual service::AwaitableObject<std::shared_ptr<Folder>> getAdded(service::FieldParams&& params) const = 0;
	};
		...
		: Concept
	{
		...
		[[nodiscard("unnecessary call")]] service::AwaitableScalar<int> getIndex(service::FieldParams&& params) const override
		{
			...
			{
				throw service::unimplemented_method(R"ex(FolderAdded::getIndex)ex");
			}
		}

		[[nodiscard("unnecessary call")]] service::AwaitableObject<std::shared_ptr<Folder>> getAdded(service::FieldParams&& params) const override
		{
			...
			{
				throw service::unimplemented_method(R"ex(FolderAdded::getAdded)ex");
			}
		}
	...
	explicit FolderAdded(std::unique_ptr<const Concept> pimpl) noexcept;
...
public:
	template <class T>
	explicit FolderAdded(std::shared_ptr<T> pimpl) noexcept
