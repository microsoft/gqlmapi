...
private:
	...
	NamedPropId(std::unique_ptr<Concept>&& pimpl) noexcept;
...
public:
	template <class T>
	NamedPropId(std::shared_ptr<T> pimpl) noexcept
		: NamedPropId { std::unique_ptr<Concept> { std::make_unique<Model<T>>(std::move(pimpl)) } }
	{
