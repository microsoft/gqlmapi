...
class [[nodiscard]] NamedId final
	: public service::Object
{
private:
	[[nodiscard]] service::AwaitableResolver resolvePropset(service::ResolverParams&& params) const;
	...
	struct [[nodiscard]] Concept
	{
		...
		[[nodiscard]] virtual service::AwaitableScalar<response::Value> getPropset(service::FieldParams&& params) const = 0;
		[[nodiscard]] virtual service::AwaitableObject<std::shared_ptr<NamedPropId>> getId(service::FieldParams&& params) const = 0;
	};
		...
		: Concept
	{
		...
		[[nodiscard]] service::AwaitableScalar<response::Value> getPropset(service::FieldParams&& params) const final
		{
		...
		[[nodiscard]] service::AwaitableObject<std::shared_ptr<NamedPropId>> getId(service::FieldParams&& params) const final
		{
	...
	NamedId(std::unique_ptr<const Concept>&& pimpl) noexcept;
